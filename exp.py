...
def generate_experiment_cfgs(id):
    def config_from_vars():
        ...
        if method_name in uda and plcrop:
            ...
            # cfg['uda']['pseudo_weight_ignore_top'] = 25
            # cfg['uda']['pseudo_weight_ignore_bottom'] = 200
        ...
        cfg['checkpoint_config'] = dict(
            by_epoch=False, interval=1000, max_keep_ckpts=40)
        # cfg['evaluation'] = dict(interval=1000, metric='mIoU', priority='LOW')
...
#         cfg['runner'] = dict(type='IterBasedRunner', max_iters=iters)
#         cfg['checkpoint_config'] = dict(
#             by_epoch=False, interval=500, max_keep_ckpts=100)
#         # cfg['evaluation'] = dict(interval=1000, metric='mIoU', priority='LOW')
#         cfg['evaluation'] = dict(interval=400000, metric='mIoU')
...
#     plcrop = True
#     fix_crop = True  # whether to fix the RandomCrop bug in DAFormer
#     start_distribution_iter = 0 # 3000 #######
#     enable_self_training = True
#     pseudo_random_crop = False
#     regen_pseudo = False
#     cat_max_ratio = 0.75  # used for CBC
